...
namespace EzySlice
{
    ...
    public static class SlicerExtensions
    {
        ...
        public static GameObject[] SliceInstantiate(this GameObject obj, Vector3 position, Vector3 direction, GameObject prefab)
        {
            return SliceInstantiate(obj, position, direction, null, prefab);
        }

        public static GameObject[] SliceInstantiate(this GameObject obj, Vector3 position, Vector3 direction, Material crossSectionMat, GameObject prefab)
        {
            return SliceInstantiate(obj, position, direction, new TextureRegion(0.0f, 0.0f, 1.0f, 1.0f), crossSectionMat, prefab);
        }

        public static GameObject[] SliceInstantiate(this GameObject obj, Vector3 position, Vector3 direction, TextureRegion cuttingRegion, Material crossSectionMaterial = null, GameObject prefab = null)
        {
            ...
            return SliceInstantiate(obj, cuttingPlane, cuttingRegion, crossSectionMaterial, obj);
        }

        public static GameObject[] SliceInstantiate(this GameObject obj, Plane pl, TextureRegion cuttingRegion, Material crossSectionMaterial = null, GameObject prefab = null)
        {
            ...
            GameObject upperHull = slice.CreateUpperHull(obj, crossSectionMaterial, obj);
            GameObject lowerHull = slice.CreateLowerHull(obj, crossSectionMaterial, obj);
